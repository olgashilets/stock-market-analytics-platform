...
![Обзор интерфейса](docs/screenshots/dashboard_preview.png)

<details>
<summary>Посмотреть отдельные страницы</summary>

### Обзор рынка / скринер
![Обзор рынка](docs/screenshots/market_overview.png)

### Карточка инструмента
![Карточка инструмента](docs/screenshots/instrument_card.png)

### Сравнение инструментов
![Сравнение инструментов](docs/screenshots/instrument_comparison.png)

### Аномалии рынка
![Аномалии рынка](docs/screenshots/market_anomalies.png)
